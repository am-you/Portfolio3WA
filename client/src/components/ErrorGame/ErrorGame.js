...
export class ErrorGame extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <div className="image404Ctn">
                    <img src={image404} alt="404 NOT FOUND"
                         className="image404"
                         width="1041"
                         height="781"/>
                    <p className="erMessageSmallScr">404<br/><i>{t('Error.lost')}</i><br/>
                        <span>{t('Error.mess')}</span>
                    </p>
                </div>
                <button
                    id="goHome"
                ...
                <div className="canvasCont">
                    ...
                    <span className="controls" ><span className="erMessage">{t('Error.header')}</span><br/>[A][S][W][D] or/ou [←][↑][↓][→] {t('Error.controls')}<br/>[SPACE] {t('Error.controls2')}
                    </span>
                    <canvas ref="canvas"
...
export default withTranslation()(ErrorGame);
